...
LAYER_REGISTRY: list[dict] = [
    ...
    {"key": "patrimoine_naturel",    "label": "Patrimoine naturel (14 sources)","table": "ecocompensation_results.patrimoine_naturel",      "fast": False, "fn": _make("patrimoine_naturel",    "ecocompensation_results.patrimoine_naturel",      _run_patrimoine_naturel)},
